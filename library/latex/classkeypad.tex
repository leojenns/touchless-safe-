...
gives the value back that the position contains out the matrix that is equal to the position that is pressed. \index{keypad@{keypad}!input\+\_\+wait@{input\+\_\+wait}}
\index{input\+\_\+wait@{input\+\_\+wait}!keypad@{keypad}}
\subsubsection[{\texorpdfstring{input\+\_\+wait()}{input_wait()}}]{\setlength{\rightskip}{0pt plus 5cm}int keypad\+::input\+\_\+wait (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{classkeypad_a2ae7159fe81ba33ee01b62688ad6e860}{}\label{classkeypad_a2ae7159fe81ba33ee01b62688ad6e860}


int input function. 

gives the value back that the position contains out the matrix that is equal to the position that is pressed deferend with void \hyperlink{classkeypad_a2a1334d93f32abfe59930a35b61bdbba}{input()} is this function\+\_\+waits until key is pressed. 
